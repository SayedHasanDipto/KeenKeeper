            ...
            <div className="hero min-h-96">
                <div className="hero-content container text-center mt-20 flex-col">
                    ...
                    <div className='grid grid-cols-4 gap-4 justify-evenly w-340'>
                        <div className='p-8 bg-white rounded-xl w-70 h-37 flex items-center justify-center flex-col hover:-translate-y-2 transition delay-75 duration-300 ease-in-out shadow'>
